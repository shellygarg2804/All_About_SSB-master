...
public class Bhopal_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "23.281852",longitude = "77.390646";
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String string =  "http://maps.google.com/maps?q=loc:" + latitude + "," + longitude + "SSB Bhopal";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Bhopal_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Bhopal_Slide.this);
                textToSpeech.stop();
            }
        });

        hotel_detials = getResources().getString(R.string.hotels_bhopal);
        info_details = getResources().getString(R.string.info_bhopal);
        places_info = getResources().getString(R.string.place_bhopal);
        reach_detail = getResources().getString(R.string.transport_bhopal);
        contact_details = getResources().getString(R.string.contact_bhopal);
