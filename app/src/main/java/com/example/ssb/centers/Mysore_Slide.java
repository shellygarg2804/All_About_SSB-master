...
public class Mysore_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "12.310411",longitude = "76.674018";
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String string =  "http://maps.google.com/maps?q=loc:" + latitude + "," + longitude + "SSB MYSORE";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Mysore_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Mysore_Slide.this);
                textToSpeech.stop();
            }
        });
        hotel_detials = getResources().getString(R.string.hotels_mysore);
        info_details = getResources().getString(R.string.info_mysore);
        places_info = getResources().getString(R.string.places_mysore);
        reach_detail = getResources().getString(R.string.transport_mysore);
        contact_details = getResources().getString(R.string.contact_mysore);
