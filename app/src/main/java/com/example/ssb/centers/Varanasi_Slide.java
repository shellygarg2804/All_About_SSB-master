...
public class Varanasi_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "25.329345",longitude = "82.986529";
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String string =  "http://maps.google.com/maps?q=loc:" + latitude + "," + longitude + "AFSB VANARASI";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Varanasi_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Varanasi_Slide.this);
                textToSpeech.stop();
            }
        });
        hotel_detials = getResources().getString(R.string.hotels_vanarasi);
        info_details = getResources().getString(R.string.info_vanarasi);
        places_info = getResources().getString(R.string.places_vanarasi);
        reach_detail = getResources().getString(R.string.transport_vanarasi);
        contact_details = getResources().getString(R.string.contact_vanarasi);
