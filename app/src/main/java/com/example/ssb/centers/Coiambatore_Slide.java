...
public class Coiambatore_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "11.007584",longitude = "76.988426";
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String string =  "http://maps.google.com/maps?q=loc:" + latitude + "," + longitude + "INS AGRANI";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Coiambatore_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Coiambatore_Slide.this);
                textToSpeech.stop();
            }
        });
        hotel_detials = getResources().getString(R.string.hotels_coimbatore);
        info_details = getResources().getString(R.string.info_coimbatore);
        places_info = getResources().getString(R.string.places_coimbatore);
        reach_detail = getResources().getString(R.string.transport_coimbatore);
        contact_details = getResources().getString(R.string.contact_coimbatore);
