...
public class Dehradun_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "30.264885",longitude = "78.002559";
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String string =  "http://maps.google.com/maps?q=loc:" + latitude + "," + longitude + "AFSB DEHRADUN";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Dehradun_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Dehradun_Slide.this);
                textToSpeech.stop();
            }
        });
        hotel_detials = getResources().getString(R.string.hotels_dehradun);
        info_details = getResources().getString(R.string.info_dehradun);
        places_info = getResources().getString(R.string.places_dehradun);
        reach_detail = getResources().getString(R.string.transport_dehradun);
        contact_details = getResources().getString(R.string.contact_dehradun);
