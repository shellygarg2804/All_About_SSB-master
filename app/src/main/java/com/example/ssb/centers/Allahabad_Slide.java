...
public class Allahabad_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "25.449979",longitude = "81.813693";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Allahabad_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Allahabad_Slide.this);
                textToSpeech.stop();
            }
        });
        hotel_detials = getResources().getString(R.string.hotels_allahabad);
        info_details = getResources().getString(R.string.info_allahabad);
        places_info = getResources().getString(R.string.places_allahabad);
        reach_detail = getResources().getString(R.string.transport_allahabad);
        contact_details = getResources().getString(R.string.contact_allahabad);
