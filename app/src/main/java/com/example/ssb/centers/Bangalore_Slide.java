...
public class Bangalore_Slide extends Activity {
    ViewPager viewPager;
    Adapter adapter;
    TextView name;
    ...
    String latitude = "12.976025",longitude = "77.613765";
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String string =  "http://maps.google.com/maps?q=loc:" + latitude + "," + longitude + "Bangalore";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_back = new Intent(Bangalore_Slide.this, Info_about_centers.class);
                startActivity(intent_back);
                Animatoo.animateSwipeRight(Bangalore_Slide.this);
                textToSpeech.stop();
            }
        });

        hotel_detials = getResources().getString(R.string.hotels_bangalore);
        info_details = getResources().getString(R.string.info_bangalore);
        places_info = getResources().getString(R.string.places_bangalore);
        reach_detail = getResources().getString(R.string.transport_bangalore);
        contact_details = getResources().getString(R.string.contact_bangalore);
